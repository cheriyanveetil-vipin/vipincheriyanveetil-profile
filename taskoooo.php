<?php include("includes/header.php"); ?>
   ...
   <!--        <button type="button" class="btn btn-danger">WCF Service</button> -->
...
<button type="button" class="btn btn-light">Asp.net MVC</button> -->
                ...
                <div id="main-slider" class="owl-carousel owl-theme">
                  ...
                  <div class="item"><img src="img/projects/taskoooo/4.JPG" alt="" class="img-fluid"></div>
                  <div class="item"><img src="img/projects/taskoooo/3.JPG" alt="" class="img-fluid"></div>
                  <div class="item"><img src="img/projects/taskoooo/2.JPG" alt="" class="img-fluid"></div>
                  <div class="item"><img src="img/projects/taskoooo/1.JPG" alt="" class="img-fluid"></div>
                </div>
                <!-- /#main-slider-->
