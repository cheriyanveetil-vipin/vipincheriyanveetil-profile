<?php include("includes/header.php"); ?>
		...
		<h1>My Projects</h1>
          ...
          <div class="grid row">
              ...
              <div class="box-masonry"> <a href="voiceboom.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/voiceboom.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="voiceboom.php" class="tile-link">  </a>
                  ...
                  <div class="box-masonry-desription">
                    <p>An IOT experiment to convert voice to text and text to voice.</p>
                  </div>
                </div>
              </div>
            </div> -->
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="dbpromoter.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/dbpromoter.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="dbpromoter.php" class="tile-link">  </a>
                  <h4>DB Promoter</h4>
                  <div class="box-masonry-desription">
                    <p>A powerfull web app in React for Neo4j database promotion.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="powerportal.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/powerportal.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="powerportal.php" class="tile-link">  </a>
                  <h4>Power Portal</h4>
                  <div class="box-masonry-desription">
                    <p>A powerfull dashboard with beautiful widgets showcasing different type of tabular or graphical representation of data. This product is well supported by highcharts</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="gowatt.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/gowatt.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="gowatt.php" class="tile-link">  </a>
                  <h4>gowatt</h4>
                  <div class="box-masonry-desription">
                    <p>A web dashboard developed in vue.js with responsive look and feel . This is for our engineer to compare the hotel power usages between different hotels and functional groups. Well supported by zoomcharts</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="allyone.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/allyone.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="allyone.php" class="tile-link">  </a>
                  <h4>Allyone</h4>
                  <div class="box-masonry-desription">
                    <p>A responsive web application developed to help an organisation in USA in their business field of helping autism kids. </p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="taskoooo.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/taskoooo.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="taskoooo.php" class="tile-link">  </a>
                  <h4>Taskoooo</h4>
                  <div class="box-masonry-desription">
                    <p>This is a web application done in python and flask as a solution for task management.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="ebooqs.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/ebooqs.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="ebooqs.php" class="tile-link">  </a>
                  <h4>ebooqs</h4>
                  <div class="box-masonry-desription">
                    <p>This is a beautiful web application for a web store of ebooks. users can come search and download them.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 grid-item"> 
              <div class="box-masonry"> <a href="donglinked.php" title="" class="box-masonry-image with-hover-overlay"><img src="img/projects/donglinked.png" alt="" class="img-fluid"></a>
                <div class="box-masonry-hover-text-header"> <a href="donglinked.php" class="tile-link">  </a>
                  <h4>DongLinked</h4>
                  <div class="box-masonry-desription">
                    <p>An SMS solution developed in C# winforms . The SMS are sent and received through a dongle with a sim card in it.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <?php
      if(isset($_GET['r']))
      {
         ?>
        <script>
        setTimeout(function(){ window.location.href = "portfolio.php"; }, 1000);
        </script>
        <?php
      }
    ?>
