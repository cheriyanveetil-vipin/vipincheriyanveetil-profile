            ...
            <div class="col-xl-12">
              <div class="content-column-content">
                ...
                <blockquote class="blockquote">
                  <p class="mb-0">This is a beautiful application done in angularjs , bootstrap annd jquyer. This app is to display ebooks and help the users to seach and  download them.   </p>
                </blockquote>
                <p class="lead">
...
<button type="button" class="btn btn-light">Asp.net MVC</button> -->
                ...
                <div id="main-slider" class="owl-carousel owl-theme">
                  ...
                  <div class="item"><img src="img/projects/ebooqs/2.JPG" alt="" class="img-fluid"></div>
                  <div class="item"><img src="img/projects/ebooqs/1.JPG" alt="" class="img-fluid"></div>
                </div>
                <!-- /#main-slider-->
